...
AOutdoorTriggerBox::AOutdoorTriggerBox()
{
	...
	CollisionBox->AttachToComponent(OutdoorTriggerRoot, FAttachmentTransformRules::KeepRelativeTransform); // attach to root component of PickupRoot
...
FVector AOutdoorTriggerBox::getLocationVec()
{
	return LocationVec;
}
