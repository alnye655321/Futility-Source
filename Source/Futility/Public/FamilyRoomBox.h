...
#include "FamilyRoomBox.generated.h"

UCLASS()
class FUTILITY_API AFamilyRoomBox : public AActor
{
	GENERATED_BODY()
...
public:	
	...
	UPROPERTY(EditAnywhere)
		USceneComponent* FamilyRoomBoxRoot;

	// collision box
	UPROPERTY(EditAnywhere)
		UShapeComponent* CollisionBox;

	UFUNCTION(BlueprintCallable, Category = "FamilyRoomTriggerBox")
